...
@Suppress // broken right now due to java.lang.ClassCastException: android.test.IsolatedContext
          // cannot be cast to com.pindroid.application.PindroidApplication
public class BookmarkContentProviderTest extends ProviderTestCase2<BookmarkContentProvider> {
  ...
  private static final Uri INVALID_URI =
      Uri.withAppendedPath(Constants.CONTENT_URI_BASE, "invalid");
  ...
  public BookmarkContentProviderTest(
      Class<BookmarkContentProvider> providerClass, String providerAuthority) {
  ...
  public void testInserts() {
    ...
    Cursor cursor =
        mMockResolver.query(BookmarkContent.Bookmark.CONTENT_URI, null, null, null, null);
