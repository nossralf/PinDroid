...
public class BrowseBookmarksFragment extends ListFragment
  ...
  @Nullable private String tagname = null;
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    mAdapter =
        new SimpleCursorAdapter(
            ...
            null,
            new String[] {
              Bookmark.Description, Bookmark.Tags, Bookmark.ToRead, Bookmark.Shared, Bookmark.Synced
            },
            new int[] {
              R.id.bookmark_description,
              R.id.bookmark_tags,
              R.id.bookmark_unread,
              R.id.bookmark_private,
              R.id.bookmark_synced
            },
            0);
  ...
  public Loader<Cursor> onCreateLoader(int id, Bundle args) {
    ...
    if (query != null) {
      ...
      return BookmarkManager.GetBookmarks(
          username, tagname, unread, untagged, sortfield, getActivity());
    }
  }
  ...
  */
  private static class SyncFinishedBroadcastReceiver extends BroadcastReceiver {
    ...
    @NonNull private final WeakReference<BrowseBookmarksFragment> fragmentRef;
