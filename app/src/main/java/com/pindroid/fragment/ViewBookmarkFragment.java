...
public class ViewBookmarkFragment extends Fragment implements PindroidFragment {
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null
        || (viewType != null && viewType.equals(BookmarkViewType.VIEW))) {
      refresh();
    } else setViews();
  }
  ...
  AccountSpan.OnAccountClickListener accountOnClickListener =
      new AccountSpan.OnAccountClickListener() {
  ...
  public void onAttach(Activity activity) {
    ...
    try {
      ...
      throw new ClassCastException(
          activity.toString()
              + " must implement OnBookmarkActionListener and OnBookmarkSelectedListener");
    }
  }
  ...
  class MyObserver extends ContentObserver {
    ...
    public void onChange(boolean selfChange) {
      try {
        bookmark =
            BookmarkManager.GetByHash(bookmark.getHash(), bookmark.getAccount(), getActivity());
