...
public class SearchWidgetProvider extends AppWidgetProvider {
  ...
  public static void updateAppWidget(
    ...
    PendingIntent bookmarkPendingIntent =
        PendingIntent.getActivity(
            context, 0, IntentHelper.ViewBookmarks(null, username, null, context), 0);
    PendingIntent unreadPendingIntent =
        PendingIntent.getActivity(context, 0, IntentHelper.ViewUnread(username, context), 0);
    PendingIntent addPendingIntent =
        PendingIntent.getActivity(context, 0, IntentHelper.AddBookmark(null, username, context), 0);
