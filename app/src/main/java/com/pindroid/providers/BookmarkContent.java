...
public class BookmarkContent {
  ...
  public static class Bookmark implements BaseColumns, Parcelable {
    ...
    public static final Uri CONTENT_URI =
        Uri.parse("content://" + BookmarkContentProvider.AUTHORITY + "/bookmark");
    public static final Uri UNREAD_CONTENT_URI =
        Uri.parse("content://" + BookmarkContentProvider.AUTHORITY + "/unreadcount");
    ...
    public ArrayList<Tag> getTags() {
      ...
      if (mTags != null) {
        for (String s : mTags.split(" ")) {
          if (!s.equals("")) result.add(new Tag(s));
        }
      }
    ...
    public boolean equals(Object obj) {
      ...
      if (mHash == null) {
        if (other.mHash != null) return false;
      } else if (!mHash.equals(other.mHash)) return false;
      return true;
    }
  }
}
