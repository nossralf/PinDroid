...
public class NoteManager {
  ...
  public static CursorLoader GetNotes(String account, String sortorder, Context context) {
    ...
    return new CursorLoader(
        context, Note.CONTENT_URI, projection, selection, selectionargs, sortorder);
  }

  public static Note GetById(int id, Context context) throws ContentNotFoundException {
    final String[] projection =
        new String[] {
          Note.Account, Note.Title, Note.Text, Note.Pid, Note.Hash, Note.Added, Note.Updated
        };
    ...
    if (c.moveToFirst()) {
      ...
      Note n =
          new Note(
              ...
              c.getString(textColumn),
              c.getString(accountColumn),
              c.getString(hashColumn),
              c.getString(pidColumn),
              c.getLong(addedColumn),
  ...
  public static void UpsertNote(Note note, String account, Context context) {
    ...
    final Cursor c =
        context
            .getContentResolver()
            .query(Note.CONTENT_URI, projection, selection, selectionargs, null);
