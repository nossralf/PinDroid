...
public class IntentHelper {
  ...
  public static Intent AddBookmark(String url, String account, Context context) {
    ...
    if (url != null) addBookmark.putExtra(Intent.EXTRA_TEXT, url);
  ...
  public static Intent ViewBookmarks(String tag, String account, String feed, Context context) {
    ...
    if (tag != null && !tag.equals("")) data.appendQueryParameter("tagname", tag);

    if (feed != null && !feed.equals("")) data.appendQueryParameter("feed", feed);
